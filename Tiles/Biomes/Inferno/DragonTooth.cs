...
namespace MultidimensionMod.Tiles.Biomes.Inferno
{
    ...
    public class DragonTooth : ModTile
    {
        ...
        public override bool CanDrop(int i, int j)
        {
            ...
            int herbItemType = ModContent.ItemType<DragonToothItem>();
            int herbItemStack = 1;

            int seedItemType = ModContent.ItemType<DragonToothSeeds>();
            int seedItemStack = 1;
        ...
        public override void NearbyEffects(int i, int j, bool closer)
        {
            ...
            PlantStage stage = GetStage(i, j);
            //Blooms between 10:30am and 1:30pm
            if (stage == PlantStage.Growing && Main.time > 21600 && Main.dayTime && Main.time <= 32400)
            {
            ...
            if (stage == PlantStage.Grown && Main.dayTime && Main.time >= 32400) //27000 is midday
            {
                tile.TileFrameX -= FrameWidth;
