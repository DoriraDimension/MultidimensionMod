...
{
	public class VoidMatterDresserPlaced : ModTile
	{
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconText = "Void Matter Dresser";
				}
				if (player.cursorItemIconText == "Void Matter Dresser")
				{
					player.cursorItemIconID = ModContent.ItemType<VoidMatterDresser>();
