	...
	public class Iceblossom : ModTile
	{
		...
		public override bool Drop(int i, int j)
		{
			...
			if (stage == PlantStage.Grown)
				Item.NewItem(new Vector2(i, j).ToWorldCoordinates(), ModContent.ItemType<IceblossomItem>());
			    Item.NewItem(new Vector2(i, j).ToWorldCoordinates(), ModContent.ItemType<IceblossomSeeds>());
