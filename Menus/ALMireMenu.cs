...
namespace MultidimensionMod.Menus
{
    ...
    public class ALMireMenu : ModMenu
    {
        ...
        public override string DisplayName => "Do not let him on social media";
        ...
        public override int Music => MultidimensionMod.Instance.GetMusicFromMusicMod("LakeDepths") ?? MusicID.MenuMusic;
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("MultidimensionMod/Menus/MireMenuBG").Value;
