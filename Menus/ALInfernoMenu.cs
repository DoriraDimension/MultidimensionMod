...
namespace MultidimensionMod.Menus
{
    ...
    public class ALInfernoMenu : ModMenu
    {
        ...
        public override string DisplayName => "Keep yourself safe";
        ...
        public override int Music => MultidimensionMod.Instance.GetMusicFromMusicMod("ChaosMenu") ?? MusicID.MenuMusic;
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("MultidimensionMod/Menus/InfernoMenuBG").Value;
