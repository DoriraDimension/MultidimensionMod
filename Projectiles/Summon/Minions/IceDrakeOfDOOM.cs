		...
		public override void AI()
		{
			...
			if (foundTarget && Main.myPlayer == base.Projectile.owner)
			{
				...
				if (Projectile.ai[0] >= 60f)
				{
					...
					velocity *= ProjSpeed;
					Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, velocity, ProjectileID.FrostBoltStaff, Projectile.damage, Projectile.knockBack, Projectile.owner);
