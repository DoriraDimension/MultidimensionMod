...
{
    internal class SunpowderBag : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 25; i++)
            {
                int dustIndex2 = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, ModContent.DustType<SunpowderDust>(), 0f, 0f, 100, default(Color), 1f);
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                target.AddBuff(ModContent.BuffType<MildBurn>(), 2400);
            }
        }
    }
}