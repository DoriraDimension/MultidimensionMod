...
namespace MultidimensionMod.Projectiles.Melee.Flails
{
    ...
    public class RisingLightFlail : ModProjectile
    {
        private const string ChainTexturePath = "MultidimensionMod/Projectiles/Melee/Flails/RisingLightChain"; // The folder path to the flail chain sprite
