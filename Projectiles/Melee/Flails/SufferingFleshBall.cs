...
namespace MultidimensionMod.Projectiles.Melee.Flails
{
	...
	public class SufferingFleshBall : ModProjectile
	{
		private const string ChainTexturePath = "MultidimensionMod/Projectiles/Melee/Flails/SufferingFleshChain"; // The folder path to the flail chain sprite
		...
		public override void AI()
		{
			...
			*/
			...
			if (Main.rand.NextBool(dustRate))
				Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, ModContent.DustType<MadnessY>(), 0f, 0f, 150, default(Color), 1.3f);
		}
        ...
        {
			target.AddBuff(ModContent.BuffType<Madness>(), 300);
        }
	}
}