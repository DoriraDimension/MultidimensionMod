...
{
    public class MoonlightBlade : ModProjectile
    {
        ...
        private float prepTime => 36f / Owner.GetTotalAttackSpeed(Projectile.DamageType);
        ...
        {
            Projectile.width = 72; // Hitbox width of projectile
        ...
        private void PrepareStrike()
        {
            ...
            if (Timer >= prepTime)
            {
                SoundEngine.PlaySound(new("MultidimensionMod/Sounds/Custom/MoonlightSlash"), Projectile.position); // Play sword sound here since playing it on spawn is too early
        ...
        private void ExecuteStrike()
        {
            ...
            if (Timer == 4f)
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity * 1.3f, ModContent.ProjectileType<MoonlightWave>(), (int)((double)(float)Projectile.damage * 0.5f), 0, Owner.whoAmI);
        }
