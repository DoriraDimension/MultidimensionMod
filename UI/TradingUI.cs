...
namespace MultidimensionMod.UI
{
    public class TradingUI : UIState
    {
        ...
        public static bool EldritchWomanLollipop = false;
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (taraha && !EldritchWoman && !Main.LocalPlayer.HasItem(ModContent.ItemType<Pink>()))
            {
                EldritchWomanLollipop = false;
            ...
            else if (taraha && !EldritchWomanLollipop && Main.LocalPlayer.HasItem(ModContent.ItemType<Pink>()))
            {
                EldritchWoman = false;
                BgSprite.RemoveAllChildren();
                int pad = 40;
                BgSprite.Append(new TradingPanelUI(new Item(ModContent.ItemType<Pink>()), new Item(ModContent.ItemType<Rambam>())));
    ...
    public class TradingPopUI : UIState
    {
        //This was achieved with help from Mod of Redemption
        private readonly UIImage BgSprite = new(ModContent.Request<Texture2D>("MultidimensionMod/Projectiles/NoTexture"));
        public static bool Visible = false;
