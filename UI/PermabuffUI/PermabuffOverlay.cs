...
namespace MultidimensionMod.UI.PermabuffUI
{
    //I'm too lazy to clean out the comments rn, so cry about it if it bothers you. :troll:
    public class PermabuffOverlay : ModResourceOverlay
    {
        ...
        public override void PostDrawResource(ResourceOverlayDrawContext context)
        {
            ...
            if (Main.LocalPlayer.GetModPlayer<PermabuffPlayer>().mushrune <= 0)
                return;
        ...
        private void DrawClassicFancyOverlay(ResourceOverlayDrawContext context)
        {
            ...
            context.texture = starTexture ??= ModContent.Request<Texture2D>("MultidimensionMod/UI/PermabuffUI/ClassicAldinManaOverlay");
            context.Draw();
        }
        ...
        private void DrawFancyPanelOverlay(ResourceOverlayDrawContext context)
        {
            ...
            // "context" contains information used to draw the resource
            // If you want to draw directly on top of the vanilla stars, just replace the texture and have the context draw the new texture
            context.texture = fancyPanelTexture ??= ModContent.Request<Texture2D>("MultidimensionMod/UI/PermabuffUI/FancyAldinManaOverlay");
        ...
        private void DrawBarsOverlay(ResourceOverlayDrawContext context)
        {
            ...
            context.texture = barsFillingTexture ??= ModContent.Request<Texture2D>("MultidimensionMod/UI/PermabuffUI/BarsAldinManaOverlay_Fill");
            context.Draw();
        }
        ...
        private void DrawBarsPanelOverlay(ResourceOverlayDrawContext context)
        {
            ...
            context.texture = barsPanelTexture ??= ModContent.Request<Texture2D>("MultidimensionMod/UI/PermabuffUI/BarsAldinManaOverlay_Panel");
