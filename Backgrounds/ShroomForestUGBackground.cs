...
namespace MultidimensionMod.Backgrounds
{
    public class ShroomForestUGBackground : ModUndergroundBackgroundStyle
    {
        public override void FillTextureArray(int[] textureSlots)
        {
            ...
            textureSlots[2] = BackgroundTextureLoader.GetBackgroundSlot("MultidimensionMod/Backgrounds/ShroomForestCBGTransition");
            textureSlots[3] = BackgroundTextureLoader.GetBackgroundSlot("MultidimensionMod/Backgrounds/ShroomForestCBG");
        }
    }
}