...
namespace MultidimensionMod.Backgrounds
{
    ...
    public class FUBackground : ModHook
    {
        ...
        private static void ILMainDrawUnderworldBackgroundLayer(ILContext il)
        {
            ...
            c.EmitDelegate(() => // Transition thingy
            {
                ...
                {
                    MultidimensionMod.FUTransition += 0.05f;
                    if (MultidimensionMod.FUTransition > 1f)
                    {
                        MultidimensionMod.FUTransition = 1f;
                    }
                }
                else
                {
                    MultidimensionMod.FUTransition -= 0.05f;
                    if (MultidimensionMod.FUTransition < 0f)
                    {
                        MultidimensionMod.FUTransition = 0f;
                    }
                }
            });
            ...
            c.EmitDelegate<Action<bool, Vector2, float, int>>((flat, screenOffset, pushUp, layerTextureIndex) =>
            {
                ...
                {
                    Main.spriteBatch.Draw(value5, vector, value3, Color.White * MultidimensionMod.FUTransition, 0f,
                    ...
                    if (layerTextureIndex == 0)
                    {
                        ...
                        Main.spriteBatch.Draw(TextureAssets.BlackTile.Value,
                            ...
                            new Color(6, 5, 6) * MultidimensionMod.FUTransition);
                    }
