...
namespace MultidimensionMod.Items.Armor
{
    class MushiumCapDraw : PlayerDrawLayer
    {
        ...
        protected override void Draw(ref PlayerDrawSet drawInfo)
        {
            ...
            DrawData drawData = new DrawData(texture, pos, drawInfo.drawPlayer.bodyFrame, drawInfo.colorArmorHead, drawInfo.drawPlayer.headRotation, drawInfo.rotationOrigin, 1f, drawInfo.playerEffect, 0)
    ...
    class MushiumBodyDraw : PlayerDrawLayer
    {
        ...
        protected override void Draw(ref PlayerDrawSet drawInfo)
        {
            ...
            {
                DrawData drawData = new DrawData(texture, pos + bobOff, drawInfo.compTorsoFrame, drawInfo.colorArmorBody, drawInfo.drawPlayer.bodyRotation, drawInfo.rotationOrigin, 1f, drawInfo.playerEffect)
            ...
            {
                DrawData drawData = new DrawData(texture, pos + bobOff, drawInfo.drawPlayer.bodyFrame, drawInfo.colorArmorBody, drawInfo.drawPlayer.bodyRotation, drawInfo.rotationOrigin, 1f, drawInfo.playerEffect, 0)
                { shader = drawInfo.cBody };
    ...
    class MushiumArmDraw : PlayerDrawLayer
    {
        ...
        protected override void Draw(ref PlayerDrawSet drawInfo)
        {
            ...
            if (drawInfo.usesCompositeTorso)
            {
                ...
                DrawData drawData = new DrawData(texture, pos + bobOff, drawInfo.compFrontArmFrame, drawInfo.colorArmorBody, rotation, bodyVect, 1f, drawInfo.playerEffect)
                { shader = drawInfo.cBody };
                ...
                {
                    DrawData drawData2 = new DrawData(texture, shoulderPos + bobOff, drawInfo.compFrontShoulderFrame, drawInfo.colorArmorBody, drawInfo.drawPlayer.bodyRotation, bodyVect, 1f, drawInfo.playerEffect)
                    { shader = drawInfo.cBody };
    ...
    class MushiumBackArmDraw : PlayerDrawLayer
    {
        public override bool GetDefaultVisibility(PlayerDrawSet drawInfo) => drawInfo.drawPlayer.body == EquipLoader.GetEquipSlot(Mod, nameof(MushiumShirt), EquipType.Body) && drawInfo.drawPlayer.GetModPlayer<MDPlayer>().IndigoMode;
        ...
        protected override void Draw(ref PlayerDrawSet drawInfo)
        {
            ...
            if (drawInfo.usesCompositeTorso)
            {
                static Vector2 GetCompositeOffset_BackArm(ref PlayerDrawSet drawinfo) => new(-5 * ((!drawinfo.playerEffect.HasFlag(SpriteEffects.FlipHorizontally)) ? 1 : (-1)), 0f);

                Vector2 pos = new Vector2((int)(drawInfo.Position.X - Main.screenPosition.X - (drawInfo.drawPlayer.bodyFrame.Width / 2) + (drawInfo.drawPlayer.width / 2)), (int)(drawInfo.Position.Y - Main.screenPosition.Y + drawInfo.drawPlayer.height - drawInfo.drawPlayer.bodyFrame.Height + 2)) + drawInfo.drawPlayer.bodyPosition + (drawInfo.drawPlayer.bodyFrame.Size() / 2);
                pos += GetCompositeOffset_BackArm(ref drawInfo);

                Vector2 bodyVect = drawInfo.bodyVect + GetCompositeOffset_BackArm(ref drawInfo);
                ...
                DrawData drawData = new DrawData(texture, pos + bobOff, drawInfo.compBackArmFrame, drawInfo.colorArmorBody, rotation, bodyVect, 1f, drawInfo.playerEffect)
                { shader = drawInfo.cBody };
                ...
                if (!drawInfo.hideCompositeShoulders)
                {
                    DrawData drawData2 = new DrawData(texture, shoulderPos + bobOff, drawInfo.compBackShoulderFrame, drawInfo.colorArmorBody, drawInfo.drawPlayer.bodyRotation, bodyVect, 1f, drawInfo.playerEffect)
                    { shader = drawInfo.cBody };
    ...
    class MushiumLegDraw : PlayerDrawLayer
    {
        ...
        protected override void Draw(ref PlayerDrawSet drawInfo)
        {
            ...
            if (drawInfo.drawPlayer.shoe != 15 || drawInfo.drawPlayer.wearsRobe)
            {
                ...
                DrawData drawData = new DrawData(texture, pos, drawInfo.drawPlayer.legFrame, drawInfo.colorArmorLegs, drawInfo.drawPlayer.legRotation, drawInfo.rotationOrigin, 1f, drawInfo.playerEffect, 0)
