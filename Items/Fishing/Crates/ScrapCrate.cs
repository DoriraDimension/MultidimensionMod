...
{
    public class ScrapCrate : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            ItemID.Sets.ShimmerTransformToItem[Type] = ModContent.ItemType<RustyCrate>();
        }
        ...
        {
            //itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<DoomiteScrap>(), 1, 5, 10));
            //itemLoot.Add(ItemDropRule.ByCondition(new DownedSagittariusCondition(), ModContent.ItemType<DoomiteBar>(), 3, 2, 4));
