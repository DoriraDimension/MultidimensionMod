...
{
    public class UnityCrate : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            ItemID.Sets.ShimmerTransformToItem[Type] = ModContent.ItemType<HarmonyCrate>();
        }
        ...
        {
            //itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<TerraShard>(), 1, 5, 10));
