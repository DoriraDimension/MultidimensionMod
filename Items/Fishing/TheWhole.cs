...
namespace MultidimensionMod.Items.Fishing
{
    public class TheWhole : ModItem
    {
        ...
        public override bool IsAnglerQuestAvailable() => false;//true;

        public override void AnglerQuestChat(ref string description, ref string catchLocation)
        {
            description = Language.GetTextValue("Mods.MultidimensionMod.Items.TheWhole.QuestDialogue");
