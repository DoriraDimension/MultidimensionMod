...
namespace MultidimensionMod.Items.Souls
{
	public class TwinSoul : ModItem
	{
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            {
                TooltipLine line = new(Mod, "Lore", Language.GetTextValue("Mods.MultidimensionMod.Items.TwinSoul.Lore"))
                {
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("MultidimensionMod/Items/Souls/TwinSoul").Value;
            Rectangle frame;
