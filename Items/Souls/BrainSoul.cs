...
namespace MultidimensionMod.Items.Souls
{
	public class BrainSoul : ModItem
	{
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            {
                TooltipLine line = new(Mod, "Lore", Language.GetTextValue("Mods.MultidimensionMod.Items.BrainSoul.Lore"))
                {
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("MultidimensionMod/Items/Souls/BrainSoul").Value;
            Rectangle frame;
